...
The primary documentation for this library is:

- The main [README](../README.md) — features, installation, quick start,
...
which are not tracked in the public repository.
