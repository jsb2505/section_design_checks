...
from section_design_checks.core.units import ForceUnit, MomentUnit, from_kn, to_knm
...
class CrackingCheck(BaseCodeCheck):
    ...
    def plot_load_cases(
        ...
        **kwargs: Any,
        ...
        """
        from section_design_checks.reinforced_concrete.analysis.crack_width_viewer import CrackWidthViewer
