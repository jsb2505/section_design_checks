# shear_utils.py
'''
Docstring for section_design_checks.reinforced_concrete.code_checks.ec2.shear_utils
...
from section_design_checks.core.units import ForceUnit, LengthUnit, from_kn, from_mm, to_kn
...
from section_design_checks.reinforced_concrete.ndp import get_ndp, get_ndp_callable
...
def calculate_tension_shift(
    *,
    ...
    Example:
        ...
        >>> from section_design_checks.reinforced_concrete.materials import ShearRebar, Rebar
