...
from section_design_checks.reinforced_concrete.thermal.binder import Binder
...
class ConcreteMix(BaseModel):
    ...
    Examples:
        >>> from section_design_checks.reinforced_concrete.thermal import Binder, ConcreteMix
        >>>
        >>> # Pure cement mix
        >>> mix1 = ConcreteMix(
        ...     cement_content=350,
